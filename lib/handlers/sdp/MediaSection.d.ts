import { IceParameters, IceCandidate, DtlsParameters, DtlsRole, PlainRtpParameters, DtlsFingerprint } from '../../Transport';
...
export declare abstract class MediaSection {
    ...
    setDtlsParameters(role: DtlsRole, fingerprint: DtlsFingerprint): void;
    pause(): void;
